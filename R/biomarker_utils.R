...
## PlotCovariateAdjustmentPCA, biomarker CovariateScatter.Anal,
## .LinearAdjustmentForBiomarker) are archived in the app repo under
## archive/covariate_adjustment_2026-09-08.md. The fold-wise plumbing
## (.BuildCovariateDesign, .RemoveCovariateEffectFold, .GetCVAdjustContext,
## .AdjustPermutationFold, .AdjustNewSamplesForPrediction) remains but is
## inert: dataSet$covariate.adjusted is never set, so every guarded branch
## resolves to the unadjusted path.
##############################################
